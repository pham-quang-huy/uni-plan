...
Use index-based entity references inside the bundle (`phases[n]`, `lane[n]`, `wave[n]`, `job[n]`, `task[n]`). Legacy keys like `P0` belong only in quoted archival filenames or historical notes.
