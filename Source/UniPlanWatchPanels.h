...
{
public:
    ftxui::Element Render(const std::vector<FWatchPlanSummary>& InPlans, int InSelectedIndex) const;
};

class PhaseDetailPanel
{
public:
    ftxui::Element Render(const FWatchPlanSummary& InPlan, int InSelectedPhaseIndex) const;
};
...
{
public:
    ftxui::Element Render(const std::vector<ValidateCheck>& InFailedChecks) const;
};

class ExecutionTaxonomyPanel
{
public:
    ftxui::Element Render(const FWatchPlanSummary& InPlan, int InSelectedPhaseIndex, int InSelectedWaveIndex, int InSelectedLaneIndex) const;
};
...
{
public:
    ftxui::Element Render(const FWatchPhaseTaxonomy& InTaxonomy, int InFilePageIndex) const;
};
...
{
public:
    ftxui::Element Render(const std::string& InVersion, const std::string& InTime, int InTick, int InPollMs, const FWatchInventoryCounters& InCounters) const;
};
