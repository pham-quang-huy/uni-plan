...
static constexpr size_t kPhaseMetricFieldCoverageRichPercent = 100;
static constexpr size_t kPhaseMetricWorkHollowItems = 10;
static constexpr size_t kPhaseMetricWorkRichItems = 40;
static constexpr size_t kPhaseMetricTestingHollowRecords = 2;
static constexpr size_t kPhaseMetricTestingRichRecords = 8;
