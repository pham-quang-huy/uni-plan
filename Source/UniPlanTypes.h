...
static constexpr const char* kSchemeSchema = "uni-plan-scheme-v1";
...
static constexpr const char* kSectionResolveSchema = "uni-plan-section-resolve-v1";
...
static constexpr const char* kDriftDiagnoseSchema = "uni-plan-drift-diagnose-v1";
...
static constexpr const char* kInventoryCacheSchema = "uni-plan-inventory-cache-v1";
static constexpr const char* kSectionSchemaSchema = "uni-plan-section-schema-v1";
...
static constexpr const char* kSectionContentSchema = "uni-plan-section-content-v1";
...
static constexpr const char* kHumanTable = "  --human                 Output as formatted ANSI table\n";
static constexpr const char* kHumanList = "  --human                 Output as formatted ANSI list\n";
static constexpr const char* kHumanDisplay = "  --human                 Output as formatted ANSI display\n";
static constexpr const char* kHumanTables = "  --human                 Output as formatted ANSI tables\n";
...
struct SchemeOptions : BaseOptions
{
    std::string mType;
};
